     ...
     <Card style="margin-top:10px">
      <div v-if="gameSettingData.xtable!=null">
        <p style="color:red;margin-top:10px;">赔付倍数范围:</p>
          <div  v-for="(item, key) in gameSettingData.xtable">
            <p style="color:red;">Pins:{{key}}</p>
            <ul class="classXtable">
              <li>
                <div style="text-align:center;">低水位</div>
                <div>
                  <div><span>下限：{{item[0].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{item[0].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">中水位</div>
                <div>
                  <div><span>下限：{{item[1].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{item[1].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">高水位</div>
                <div>
                  <div><span>下限：{{item[2].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{item[2].max}}</span></div>
                </div>
              </li>
            </ul>
          </div>
      ...
      >
          <div v-if="gameSettingData.xtable!=null">
            <div v-for="(item, key) in gameSettingData.xtable">
                  <div style="color:red;">Pins:{{key}}</div>
                  <ul class="classPlinkoAllEditXtable">
                    <li>
                      <div style="display:flex;">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">低水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[0].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[0].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">中水位</div> 
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[1].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[1].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">高水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[2].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="item[2].max"/></span></div>
                      </div>
                    </li>
                  </ul>
              </div>
 ...
 export default {
   ...
   methods: {
     ...
     async saveBairenGameSettingData() {
       ...
       let ok = true;
       Object.keys(this.gameSettingData.xtable).forEach(key => {
          let element = this.gameSettingData.xtable[key];
...
#normal li,#hrm li{
 ...
 .classPlinkoAllEditXtable{
    list-style:none;
    border:1px solid lightgray;
    margin-top:2px;
 }

 .classPlinkoAllEditXtable li{
  width:350px;
  margin-right:20px;
 ...
 /* .classPlinkoAllEditXtable li Input {
    width:80px;
    height:25px;
    margin-top:4px;
 } */
