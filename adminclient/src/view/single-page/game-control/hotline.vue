<template>
    <div>
     ...
     <Card style="margin-top:10px">
      <div v-if="gameSettingData.xtable!=null">
        <p style="color:red;margin-top:10px;">赔付倍数范围:</p>
          <div>
            ...
            <ul class="classXtable">
              <li>
                <div style="text-align:center;">低水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[0][0].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[0][0].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">中水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[0][1].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[0][1].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">高水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[0][2].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[0][2].max}}</span></div>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            <p style="color:red;">高赔率模式:</p>
            <ul class="classXtable">
              <li>
                <div style="text-align:center;">低水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[1][0].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[1][0].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">中水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[1][1].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[1][1].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">高水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[1][2].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[1][2].max}}</span></div>
                </div>
              </li>
            </ul>
          </div>
      ...
      >
          <div v-if="gameSettingData.xtable!=null">
            <div >
                  <div style="color:red;">普通模式:</div>
                  <ul class="classPlinkoAllEditXtable">
                    <li>
                      <div style="display:flex;">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">低水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][0].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][0].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">中水位</div> 
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][1].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][1].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">高水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][2].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[0][2].max"/></span></div>
                      </div>
                    </li>
                  </ul>
              </div>
              ...
              <div >
                  <div style="color:red;">高赔率模式:</div>
                  <ul class="classPlinkoAllEditXtable">
                    <li>
                      <div style="display:flex;">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">低水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][0].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][0].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">中水位</div> 
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][1].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][1].max"/></span></div>
                      </div>
                    </li>
                    <li>
                      <div style="display:flex">
                        <div style="color:red;margin-right:5px;margin-top:5px;width:40px">高水位</div>
                        <div style="width:300px;display:flex;"><span style="margin-top:5px;">下限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][2].min"/></span> <span style="margin-top:5px;">上限：</span><span style="width:100px;"><Input type="number"  v-model.number="gameSettingData.xtable[1][2].max"/></span></div>
                      </div>
                    </li>
                  </ul>
              </div>
     ...
     <Card style="margin-top:10px">
      <div v-if="gameSettingData.normal!=null&&gameSettingData.hrm!=null">
        <p style="color:red;margin-top:10px;">普通模式设置:</p>
        <ul id="normal" style="list-style: none;">
          <li><span>红色权重:</span><span>{{gameSettingData.normal[0].w}}</span><span>红色倍率:</span><span>{{gameSettingData.normal[0].x}}</span></li>
          <li><span>金色权重:</span><span>{{gameSettingData.normal[1].w}}</span><span>金色倍率:</span><span>{{gameSettingData.normal[1].x}}</span></li>
          <li><span>黑色权重:</span><span>{{gameSettingData.normal[2].w}}</span><span>黑色倍率:</span><span>{{gameSettingData.normal[2].x}}</span></li>
        </ul>
        <p style="color:red;margin-top:10px;">高赔率模式设置:</p>
        <ul id="hrm" style="list-style: none;">
          <li><span>红色权重:</span><span>{{gameSettingData.hrm[0].w}}</span><span>红色倍率:</span><span>{{gameSettingData.hrm[0].x}}</span></li>
          <li><span>金色权重:</span><span>{{gameSettingData.hrm[1].w}}</span><span>金色倍率:</span><span>{{gameSettingData.hrm[1].x}}</span></li>
          <li><span>黑色权重:</span><span>{{gameSettingData.hrm[2].w}}</span><span>黑色倍率:</span><span>{{gameSettingData.hrm[2].x}}</span></li>
        </ul>
      </div>
      <div style="margin-top:10px;">
        <Button 
                @click="showModeControlSettingPage"
                type="primary"
              >
              修改
              </Button>
      ...
      <Modal
          v-model="showModeControlSetting"
          title="游戏模式参数设置"
          @on-ok="saveBairenGameSettingData(false)"
      >
      <div v-if="gameSettingData.normal!=null" style="border: 1px solid  red; padding:5px;border-radius:5px;">
        <p style="color:red;">普通模式:</p>
          <span>红色权重</span>
          <Input type="number" v-model.number="gameSettingData.normal[0].w"/>
          <span>红色倍率</span>
          <Input type="number" v-model.number="gameSettingData.normal[0].x" />
          <span>金色权重</span>
          <Input type="number" v-model.number="gameSettingData.normal[1].w" />
          <span>金色倍率</span>
          <Input type="number" v-model.number="gameSettingData.normal[1].x" />
          <span>黑色权重</span>
          <Input type="number" v-model.number="gameSettingData.normal[2].w" />
          <span>黑色倍率</span>
          <Input type="number" v-model.number="gameSettingData.normal[2].x" />
      </div>

      <div v-if="gameSettingData.hrm!=null" style="border: 1px solid  red; padding:5px;border-radius:5px;margin-top:10px;">
        <p style="color:red;">高赔率模式:</p>
          <span>红色权重</span>
          <Input type="number" v-model.number="gameSettingData.hrm[0].w"/>
          <span>红色倍率</span>
          <Input type="number" v-model.number="gameSettingData.hrm[0].x" />
          <span>金色权重</span>
          <Input type="number" v-model.number="gameSettingData.hrm[1].w" />
          <span>金色倍率</span>
          <Input type="number" v-model.number="gameSettingData.hrm[1].x" />
          <span>黑色权重</span>
          <Input type="number" v-model.number="gameSettingData.hrm[2].w" />
          <span>黑色倍率</span>
          <Input type="number" v-model.number="gameSettingData.hrm[2].x" />
      </div>
      </Modal>
     </Card>
 ...
 export default {
   ...
   methods: {
     ...
     showModeControlSettingPage(){
      this.showModeControlSetting = true;
     },
     ...
     async saveBairenGameSettingData() {
       ...
       let hotlineConfig = {};
       hotlineConfig.award_odds=[];
       hotlineConfig.limits={};
       hotlineConfig.normal = this.gameSettingData.normal;
       hotlineConfig.hrm = this.gameSettingData.hrm;
       hotlineConfig.fix_hit = this.gameSettingData.fix_hit;
       hotlineConfig.xtable = this.gameSettingData.xtable;
       this.gameSettingData.award_odds.forEach(element => {
        hotlineConfig.award_odds.push({
      ...
      for (let key in this.gameSettingData.limits) {
        if (this.gameSettingData.limits.hasOwnProperty(key)) {
          ...
          hotlineConfig.limits[this.gameSettingData.limits[key].name]=item;
        }
      }
       let Data = {
         token: getToken(),
         gameId:this.paramBairen,
         config:JSON.stringify(hotlineConfig),
       };
       //提交保存
