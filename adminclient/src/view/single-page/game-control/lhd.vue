     ...
     >
         <div v-if="currentBairenGameSettingData">
             <div>
                 ...
                 <span>开和概率</span>
                 <Input type="number" v-model="currentBairenGameSettingData.he_odds" />
             </div>
         </div>
         <div v-else></div>
     </Modal>
 ...
 export default {
                         ...
                         async onOk() {
                           ...
                           tmp.forEach(element => {
                             d.push({
                               ...
                               he_odds:parseInt(element.he_odds),
                               pool_odds:[
                                 {
   ...
   methods: {
     filterChoseChange(data) {
        console.log(this.currentBairenGameSettingData.he_odds);
     },
     showBairenGameSettingDataPage(row,isAdd) {
      console.log(row)
       if (!isAdd){
         ...
         this.currentBairenGameSettingData.he_odds = row.he_odds;
       }else{
         ...
         this.currentBairenGameSettingData.he_odds=0;
       }
