     ...
     <Card style="margin-top:10px">
      <div v-if="gameSettingData.xtable!=null">
        <p style="color:red;margin-top:10px;">赔付倍数范围:</p>
          ...
          <div>
            <p style="color:red;">Large</p>
            <ul class="classXtable">
              <li>
                <div style="text-align:center;">低水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[2][0].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[2][0].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">中水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[2][1].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[2][1].max}}</span></div>
                </div>
              </li>
              <li>
                <div style="text-align:center;">高水位</div>
                <div>
                  <div><span>下限：{{gameSettingData.xtable[2][2].min}}</span>&nbsp&nbsp&nbsp&nbsp<span>上限：{{gameSettingData.xtable[2][2].max}}</span></div>
                </div>
              </li>
            </ul>
          </div>
      ...
      >
          <div v-if="gameSettingData.xtable!=null">
            <div>
              <div>
                <p style="color:red;">Small</p>
                <ul class="classAllEditXtable">
                  <li>
                    <div style="text-align:center;">低水位</div>
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[0][0].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[0][0].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[0][1].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[0][1].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[0][2].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[0][2].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="classAllEditXtable">
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[1][0].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[1][0].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[1][1].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[1][1].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  ...
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[1][2].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[1][2].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="classAllEditXtable">
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[2][0].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[2][0].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[2][1].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[2][1].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                  ...
                  <li>
                    ...
                    <div>
                      <ul class="edit_xtable">
                        <li><span>下限：<Input type="number" v-model.number="gameSettingData.xtable[2][2].min"/></span>&nbsp&nbsp&nbsp&nbsp<span>上限：<Input type="number" v-model.number="gameSettingData.xtable[2][2].max"/></span></li>
                      </ul>
                    </div>
                  </li>
                </ul>
 ...
 export default {
   ...
   methods: {
     ...
     async saveBairenGameSettingData() {
       ...
       let goalConfig = {};
       goalConfig.award_odds=[];
       goalConfig.limits={};
       let ok=true;
       this.gameSettingData.xtable.forEach(element => {
          if (element.min >= element.max) {
            this.$Message.error("配置有问题，最小值不能<=最大值");
            ok=false
          }
       });
       if (!ok) {
       ...
       goalConfig.xtable = this.gameSettingData.xtable;
       goalConfig.fix_hit = this.gameSettingData.fix_hit;
       this.gameSettingData.award_odds.forEach(element => {
        goalConfig.award_odds.push({
      ...
      for (let key in this.gameSettingData.limits) {
        if (this.gameSettingData.limits.hasOwnProperty(key)) {
          ...
          goalConfig.limits[this.gameSettingData.limits[key].name]=item;
        }
      }
       let Data = {
         token: getToken(),
         gameId:this.paramBairen,
         config:JSON.stringify(goalConfig),
       };
       console.log(goalConfig.limits);
       //提交保存
